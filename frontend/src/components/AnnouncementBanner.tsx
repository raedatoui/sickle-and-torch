    ...
    return (
        <div className={`w-full max-w-4xl mx-auto my-8 p-1 ${className}`}>
            <div className="relative border border-gold-dim bg-black/80 backdrop-blur-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[0_0_20px_rgba(201,162,39,0.1)]">
                {/* Decorative corners */}
                <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-gold-primary" />
                <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-gold-primary" />
                <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-gold-primary" />
